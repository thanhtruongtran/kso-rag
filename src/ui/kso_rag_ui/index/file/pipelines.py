...
from kso_rag_core.base import BaseComponent, Document, Node, Param, RetrievedDocument
from kso_rag_core.embeddings import BaseEmbeddings
from kso_rag_core.indices import VectorIndexing, VectorRetrieval
from kso_rag_core.indices.ingests.files import (
    KSO_RAG_DEFAULT_FILE_EXTRACTORS,
    adobe_reader,
    azure_reader,
    docling_reader,
    unstructured,
...
from kso_rag_core.indices.rankings import BaseReranking, LLMReranking, LLMTrulensScoring
from kso_rag_core.indices.splitters import BaseSplitter, TokenSplitter
from kso_rag_ui.db.models import engine
from kso_rag_ui.embeddings.manager import embedding_models_manager
from kso_rag_ui.llms.manager import llms
from kso_rag_ui.rerankings.manager import reranking_models_manager
...
class IndexDocumentPipeline(BaseFileIndexIndexing):
    ...
    def readers(self):
        readers = deepcopy(KSO_RAG_DEFAULT_FILE_EXTRACTORS)
