...
from kso_rag_core.base import BaseComponent
from kso_rag_core.storages import BaseDocumentStore, BaseVectorStore

logger = logging.getLogger(__name__)


filestorage_path = Path(settings.KSO_RAG_FILESTORAGE_PATH)
...
def get_docstore(collection_name: str = "default") -> BaseDocumentStore:
    ...
    ds_conf = deepcopy(settings.KSO_RAG_DOCSTORE)
...
def get_vectorstore(collection_name: str = "default") -> BaseVectorStore:
    ...
    vs_conf = deepcopy(settings.KSO_RAG_VECTORSTORE)
