...
from kso_rag_ui.rerankings.manager import reranking_models_manager as rerankers
from theflow.settings import settings as flowsettings

KSO_RAG_OLLAMA_URL = getattr(flowsettings, "KSO_RAG_OLLAMA_URL", "http://localhost:11434/v1/")
DEFAULT_OLLAMA_URL = KSO_RAG_OLLAMA_URL.replace("v1", "api")
