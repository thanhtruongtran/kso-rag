...
from kso_rag_ui.db.models import User, engine
...
class UserManagement(BasePage):
    def __init__(self, app):
        ...
        self.on_building_ui()
        if hasattr(flowsettings, "KSO_RAG_FEATURE_USER_MANAGEMENT_ADMIN") and hasattr(
            flowsettings, "KSO_RAG_FEATURE_USER_MANAGEMENT_PASSWORD"
        ):
            usn = flowsettings.KSO_RAG_FEATURE_USER_MANAGEMENT_ADMIN
            pwd = flowsettings.KSO_RAG_FEATURE_USER_MANAGEMENT_PASSWORD
