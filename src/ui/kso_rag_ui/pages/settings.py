...
class SettingsPage(BasePage):
    ...
    **IMPORTANT**: the name and id of the UI setting components should match the
    ...
    def __init__(self, app):
        ...
        if not KSO_RAG_SSO_ENABLED and self._default_settings.application.settings:
    ...
    def on_register_events(self):
        ...
        if self._app.f_user_management and not KSO_RAG_SSO_ENABLED:
    ...
    def change_password(self, user_id, password, password_confirm):
        from kso_rag_ui.pages.resources.user import validate_password
