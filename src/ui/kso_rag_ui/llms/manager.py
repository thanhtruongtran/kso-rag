...
class LLMManager:
    ...
    def __init__(self):
        ...
        if hasattr(flowsettings, "KSO_RAG_LLMS"):
            for name, model in flowsettings.KSO_RAG_LLMS.items():
    ...
    def load_vendors(self):
        ...
        for extra_vendor in getattr(flowsettings, "KSO_RAG_LLM_EXTRA_VENDORS", []):
