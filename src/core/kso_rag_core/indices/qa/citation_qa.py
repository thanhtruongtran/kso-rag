...
from kso_rag_core.llms import ChatLLM, PromptTemplate
...
try:
    ...
    from kso_rag_ui.reasoning.prompt_optimization.mindmap import CreateMindmapPipeline
    from kso_rag_ui.utils.render import Render
except ImportError:
    raise ImportError("Please install `kso_rag_ui` to use this component")
...
class AnswerWithContextPipeline(BaseComponent):
    ...
    vlm_endpoint: str = getattr(flowsettings, "KSO_RAG_VLM_ENDPOINT", "")
    use_multimodal: bool = getattr(flowsettings, "KSO_RAG_REASONINGS_USE_MULTIMODAL", True)
